...
HD_PWD='C:/xilinx_projects/communication/communication.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_power_energy_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_power_energy_display.tcl -notrace
