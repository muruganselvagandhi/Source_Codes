...
HD_PWD='C:/xilinx_projects/communication/communication.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_power_energy_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_power_energy_display.tcl
